...
def simulated_annealing(Adj,Iterations, Temperature0, ALPHA,P,A,objectives,iterations,itt,bests):
    ...
    return BestMatrX, Bestfitness,P_best,objectives,iterations,itt,bests  
...
def rowswap(BlokmatriX, n):
    ...
    selected_block_matrix = BlokmatriX[Rowstart:Rowend, ColumnStart:ColumnEnd]
    ...
    selected_block_matrix[[row1, row2], :] = selected_block_matrix[[row2, row1], :]
    
    # Update the original block matrix with the modified block
    BlokmatriX[Rowstart:Rowend, ColumnStart:ColumnEnd] = selected_block_matrix
    BlokmatriX[ ColumnStart:ColumnEnd, Rowstart:Rowend] = selected_block_matrix.T
...
def simulated_annealing2(Adj,Iterations, Temperature0, ALPHA,P):
    ...
    return BestMatrX, Bestfitness, P_best
